...
- **Pico de memória observado:** 1.418 MB (~1,4 GB) — medido com psutil no dataset diabetes (n=768) em Kaggle T4 GPU; datasets do regime large (n > 45k) consomem proporcionalmente mais
